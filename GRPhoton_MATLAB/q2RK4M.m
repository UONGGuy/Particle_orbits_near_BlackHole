function RK4 = q2RK4M(r0,P,h,H)

%r0 is initial radius, P is phi to run for, h is specific ang mom, H is step size
f = @(phi,u,z) z; %for U_n
g = @(phi,u,z) 3./2.*u.^2-u+1./(2.*h.^2); %for Z_n
RK4 = zeros(1+P./H,5); % storage matrix
P = 0:H:P;
RK4(:,2) = P(:)'; % phi range
